...
function Body() {
    return(
        <div className='body-css'>
            <h1>LES PRINCIPES</h1>
            <h2 className="body-reglement">Le football américain est un jeu de gagne-terrain ou l’attaque doit atteindre l’en-but (End zone)
            ...
            (en charge des coups de pieds). Mais sur le terrain c’est bien 11 joueurs contre 11 joueurs avec des rôles bien précis.</h2>
            <h1>L'ATTAQUE</h1>
            <h2>Pour avancer l’équipe d’attaque dispose de quatre tentatives pour gagner 10 yards (9,1 m) . Si elle y parvient (que ce soit dès sa première tentative ou lors de son ultime essai),
            ...
            <h1>LA DÉFENSE</h1>
            <h2>La défense cherche à empêcher l’attaque de progresser. Pour cela elle peut PLAQUER le joueur attaquant possesseur du ballon pour le stopper. La prochaine phase offensive débutera alors à l’endroit précis où le porteur de balle a été plaqué.
            ...
            <h1>L’EQUIPEMENT</h1>
            <img src ={Equipement} alt= 'Equipement-foot-us'/>
        </div>
    )
}
